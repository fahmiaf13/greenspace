...
const fetchListParkingSpot = async () => {
  loading.table = true;
  try {
    const response: Response<ParkingSpot[]> = await $fetch(`https://greenspace-be-git-dev-fahmiaf13.vercel.app/parking/spot`, { method: "GET", withCredentials: true, credentials: "include" });
